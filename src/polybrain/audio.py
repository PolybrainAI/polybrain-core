...
class Audio:
    ...
    @staticmethod
    def save_wave_file(filename: str, data: bytes, sample_width: int, channels: int, rate: int) -> None:
        """
    ...
    def get_audio_input(self) -> str:
        ...
        self.save_wave_file("output.wav", audio_data, pyaudio.PyAudio().get_sample_size(self.FORMAT), self.CHANNELS, self.RATE)
